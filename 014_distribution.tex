\section{Distribution of the Determinant of a Complex-Valued Sample Correlation Matrix}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth,keepaspectratio]{014_001_Fig_Det_R.png}
\end{figure}
